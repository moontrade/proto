...
func (s *BlockHeader) Count() int32 {
	return s.count
}
func (s *BlockHeader) Seq() int32 {
	return s.seq
}
func (s *BlockHeader) Size() int32 {
	return s.size
}
func (s *BlockHeader) SizeU() int32 {
	return s.sizeU
}
func (s *BlockHeader) SizeX() int32 {
	return s.sizeX
}
...
func (s *BlockHeaderMut) SetCount(v int32) *BlockHeaderMut {
	s.count = v
	return s
}
func (s *BlockHeaderMut) SetSeq(v int32) *BlockHeaderMut {
	s.seq = v
	return s
}
func (s *BlockHeaderMut) SetSize(v int32) *BlockHeaderMut {
	s.size = v
	return s
}
func (s *BlockHeaderMut) SetSizeU(v int32) *BlockHeaderMut {
	s.sizeU = v
	return s
}
func (s *BlockHeaderMut) SetSizeX(v int32) *BlockHeaderMut {
	s.sizeX = v
	return s
}
...
func (s *Bytes1968) StringClone() string {
	b := s[0:1968]
	return string(b)
}
...
func (s *Bytes32688) StringClone() string {
	b := s[0:32688]
	return string(b)
}
...
func (s *Bytes944) StringClone() string {
	b := s[0:944]
	return string(b)
}
...
func (s *Bytes65456) StringClone() string {
	b := s[0:65456]
	return string(b)
}
...
func (s *Bytes4016) StringClone() string {
	b := s[0:4016]
	return string(b)
}
...
func (s *Bytes8112) StringClone() string {
	b := s[0:8112]
	return string(b)
}
...
func (s *Bytes16306) StringClone() string {
	b := s[0:16306]
	return string(b)
}
...
func init() {
	...
	a(StreamStats{}, StreamStatsMut{}, 48, []b{
		{"storage", 0, 24},
		{"appender", 24, 24},
	})
	a(Block16{}, Block16Mut{}, 16408, []b{
		{"head", 0, 96},
		{"body", 96, 16306},
		{"_", 16402, 6},
	})
	...
	a(Block32{}, Block32Mut{}, 32784, []b{
		{"head", 0, 96},
		{"body", 96, 32688},
	})
	a(Block1{}, Block1Mut{}, 1040, []b{
		{"head", 0, 96},
		{"body", 96, 944},
	})
	...
	a(RecordHeader{}, RecordHeaderMut{}, 80, []b{
		{"streamID", 0, 8},
		{"blockID", 8, 8},
		{"id", 16, 8},
		{"timestamp", 24, 8},
	...
	a(BlockHeader{}, BlockHeaderMut{}, 96, []b{
		{"streamID", 0, 8},
		{"id", 8, 8},
		{"created", 16, 8},
		{"completed", 24, 8},
	...
	a(AccountStats{}, AccountStatsMut{}, 64, []b{
		{"id", 0, 8},
		{"storage", 8, 24},
		{"appender", 32, 24},
		{"streams", 56, 8},
	...
	a(Block4{}, Block4Mut{}, 4112, []b{
		{"head", 0, 96},
		{"body", 96, 4016},
	})
	a(Block8{}, Block8Mut{}, 8208, []b{
		{"head", 0, 96},
		{"body", 96, 8112},
	})
	a(Block64{}, Block64Mut{}, 65552, []b{
		{"head", 0, 96},
		{"body", 96, 65456},
	})
